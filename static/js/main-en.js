$(document).ready(function () {
    ...
    var name=['classes','lecture schedule','lectures',"users",
        'sections','students','students','sections','lecture schedule',"users",'lectures','sections','lecture schedule','lectures','institutes'];
    ...
    for(var i=0;i<id1.length;i++){
        ...
        $(id1[i]+'_filter').children().first().children().first().attr('placeholder','search');
        $(id1[i]+'_filter').children().first().after(
        ...
        $(id1[i]+'_wrapper').children().first().children().first().css('order',2);
        $(id1[i]+'_info').css('float','left');
        $(id1[i]+'_filter').css('float','right');
    ...
    for(var i=0;i<id2.length;i++){
        ...
        $(id2[i]+'_wrapper').children().first().children().html(
    ...
    for(var i=0;i<id3.length;i++){
        ...
        $(id3[i]+'_filter').children().first().children().first().attr('placeholder','search');
        $(id3[i]+'_wrapper').children().first().children().first().css('order',2);
        $(id3[i]+'_info').css('float','left');
        $(id3[i]+'_filter').css('float','right');
    }

    $('#table-courses_filter').children().first().after(
